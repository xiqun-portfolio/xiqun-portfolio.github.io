...
/*	window.scroll = function(){
		if(document.scrollTop() >= 100){
			addClass.getElementsByClassName('stickyTop'), 'stickyTopTwo'));
    }else{
	removeClass.getElementsByClassName('stickyTop'), 'stickyTopTwo');
    }
}*/
...
function mouseaction(type, obj, num) {
  if (type === 'mouseover') {
    
      if (num === 0) {
          window.addClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active1');
          window.addClass(obj.getElementsByClassName('description')[0], 'description-active1');
          window.addClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active1');
          window.addClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active1');
      } else if (num === 1) {
          window.addClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active2');
          window.addClass(obj.getElementsByClassName('description')[0], 'description-active2');
          window.addClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active2');
          window.addClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active2');
      } else if (num === 2) {
          window.addClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active3');
          window.addClass(obj.getElementsByClassName('description')[0], 'description-active3');
          window.addClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active3');
          window.addClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active3');
      } else if (num === 3) {
          window.addClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active4');
          window.addClass(obj.getElementsByClassName('description')[0], 'description-active4');
          window.addClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active4');
          window.addClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active4');
      }
      obj.getElementsByClassName('icon-bg-small')[0].setAttribute('src', 'img/skills-active.png');
  } else {
    
      if (num === 0) {
          window.removeClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active1');
          window.removeClass(obj.getElementsByClassName('description')[0], 'description-active1');
          window.removeClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active1');
          window.removeClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active1');
      } else if  (num === 1) {
          window.removeClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active2');
          window.removeClass(obj.getElementsByClassName('description')[0], 'description-active2');
          window.removeClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active2');
          window.removeClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active2');
      } else if (num === 2) {
          window.removeClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active3');
          window.removeClass(obj.getElementsByClassName('description')[0], 'description-active3');
          window.removeClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active3');
          window.removeClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active3');
      } else if (num === 3) {
          window.removeClass(obj.getElementsByClassName('icon-small')[0], 'icon-small-active4');
          window.removeClass(obj.getElementsByClassName('description')[0], 'description-active4');
          window.removeClass(obj.getElementsByClassName('skills-title')[0], 'skills-title-active4');
          window.removeClass(obj.getElementsByClassName('icon-bg-small')[0], 'icon-bg-small-active4');
      }
